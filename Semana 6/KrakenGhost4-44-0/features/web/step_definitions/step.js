...
Given('I login email {kraken-string} and password {kraken-string}', async function (email, password) {
    ...
    let elementLogin = await this.driver.$('.gh-btn-login');
...
When('I click Forgot?', async function() {
    let element = await this.driver.$('.forgotten-link');
...
When('I click confirm publish', async function() {
    let element = await this.driver.$('button.gh-publishmenu-button');
    await takeCustomScreenshot(this.driver, "clickPublishRightNow", null);
    await element.click();
});

When('I click confirm modal publish', async function() {
    let element = await this.driver.$('.gh-btn-black');
    await takeCustomScreenshot(this.driver, "clickPublishRightNow", null);
    await element.click();
});

When('I click schedule', async function() {
    let element = await this.driver.$('button.gh-publishmenu-button');
    await takeCustomScreenshot(this.driver, "clickPublishRightNow", null);
    await element.click();
});

When('I click confirm modal schedule', async function() {
    let element = await this.driver.$('.gh-btn-black');
    await takeCustomScreenshot(this.driver, "clickPublishRightNow", null);
    await element.click();
});
...
When('I click schedule for later', async function() {
    let element = await this.driver.$('div=Schedule it for later');
...
When('I click confirm update', async function() {
    let element = await this.driver.$('.gh-btn-black');
    await takeCustomScreenshot(this.driver, "clickUpdate", null);
    await element.click();
});
