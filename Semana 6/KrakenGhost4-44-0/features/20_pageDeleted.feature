Feature: Eliminar page del sitio web del usuario administrador

@user1 @web
Scenario: Como usuario administrador elimino una page (caso positivo)
  ...
  And I wait for 2 seconds
  When I click page published
  And I wait for 2 seconds
  And I click settings page
  And I wait for 2 seconds
  And I click deleted page
  And I wait for 2 seconds
  Then I confirm delete page
