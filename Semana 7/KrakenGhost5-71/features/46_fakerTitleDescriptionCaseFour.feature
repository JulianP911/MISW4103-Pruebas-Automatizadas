...
@user1 @web
Scenario: Como usuario administrador edito titulo y descripcion del sitio web (Algunos campos largos)
  ...
  And I wait for 2 seconds
  And I enter title web site "4"
  And I wait for 2 seconds
  And I enter description web site "4"
  And I wait for 2 seconds
