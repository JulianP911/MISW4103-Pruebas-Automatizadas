Feature: Editar el idioma del sitio web del usuario adminsitrador exitoso

@user1 @web
Scenario: Como usuario administrador edito el idioma del sitio web (Idioma valido)
  ...
  And I wait for 2 seconds
  And I enter language web site "1"
  And I wait for 2 seconds
