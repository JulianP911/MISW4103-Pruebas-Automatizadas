...
@user1 @web
Scenario: Como usuario administrador edito un member para suscribirlo al contenido del sitio web (Campos vacios	)
  ...
  And I wait for 2 seconds
  And I enter member email "anaaaa@yopmail.com"
  And I wait for 2 seconds
  ...
  And I wait for 2 seconds
  And I enter member name dynamic "6"
  And I wait for 2 seconds
  And I enter member email dynamic "6"
  And I wait for 2 seconds
  And I enter member note dynamic "6"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
