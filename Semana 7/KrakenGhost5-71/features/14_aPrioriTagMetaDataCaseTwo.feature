...
@user1 @web
Scenario: Como usuario administrador creo un nuevo tag con Meta data (Con formato invalido url)
  ...
  And I wait for 2 seconds
  And I enter tag meta title "2"
  And I wait for 2 seconds
  And I enter tag meta description "2"
  And I wait for 2 seconds
  And I enter tag meta url "2"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  Then I see error tag meta data url