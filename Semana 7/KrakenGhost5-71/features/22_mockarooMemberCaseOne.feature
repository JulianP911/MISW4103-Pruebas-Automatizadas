...
@user1 @web
Scenario: Como usuario administrador edito un member para suscribirlo al contenido del sitio web (Nombre, email y nota validos)
  ...
  And I wait for 2 seconds
  And I enter member name dynamic "1"
  And I wait for 2 seconds
  And I enter member email dynamic "1"
  And I wait for 2 seconds
  And I enter member note dynamic "1"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  And I click members
  And I wait for 2 seconds
  Then I see member edited dynamic