...
@user1 @web
Scenario: Como usuario administrador edito un tag (Campos vacios)
  ...
  And I wait for 2 seconds
  And I enter tag name dynamic "6"
  And I wait for 2 seconds
  And I enter tag description dynamic "6"
  And I wait for 2 seconds
  And I enter tag color dynamic "6"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  And I click tags
  And I wait for 2 seconds
  Then I see tag edited name, description and color dynamic