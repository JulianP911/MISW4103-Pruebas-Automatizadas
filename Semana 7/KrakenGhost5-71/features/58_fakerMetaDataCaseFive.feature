...
@user1 @web
Scenario: Como usuario administrador edito la meta data del sitio web (Algunos campos largos)
  ...
  And I wait for 2 seconds
  And I enter title meta data "5"
  And I wait for 2 seconds
  And I enter description meta data "5"
  And I wait for 2 seconds
