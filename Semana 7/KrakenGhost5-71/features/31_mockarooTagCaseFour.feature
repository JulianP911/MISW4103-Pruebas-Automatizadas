...
@user1 @web
Scenario: Como usuario administrador edito un tag (Algunos campos largos)
  ...
  And I wait for 2 seconds
  And I enter tag name dynamic "4"
  And I wait for 2 seconds
  And I enter tag description dynamic "4"
  And I wait for 2 seconds
  And I enter tag color dynamic "4"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
