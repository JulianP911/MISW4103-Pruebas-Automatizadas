...
@user1 @web
Scenario: Como usuario administrador edito titulo y descripcion del sitio web (Campos con caracteres especiales)
  ...
  And I wait for 2 seconds
  And I enter title web site "5"
  And I wait for 2 seconds
  And I enter description web site "5"
  And I wait for 2 seconds
