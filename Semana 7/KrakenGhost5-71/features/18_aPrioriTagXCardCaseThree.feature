...
@user1 @web
Scenario: Como usuario administrador creo un nuevo tag con X card	(Sin X titulo pero con X descripcion)
  ...
  And I wait for 2 seconds
  And I enter tag x title "3"
  And I wait for 2 seconds
  And I enter tag x description "3"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  And I click tags
