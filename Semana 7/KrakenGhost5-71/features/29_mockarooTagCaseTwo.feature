...
@user1 @web
Scenario: Como usuario administrador edito un tag (Sin nombre pero con descripcion y color validos)
  ...
  And I wait for 2 seconds
  And I enter tag name dynamic "2"
  And I wait for 2 seconds
  And I enter tag description dynamic "2"
  And I wait for 2 seconds
  And I enter tag color dynamic "2"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  And I click tags
  And I wait for 2 seconds
  Then I see tag edited name dynamic