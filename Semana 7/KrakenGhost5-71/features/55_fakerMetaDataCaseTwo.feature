...
@user1 @web
Scenario: Como usuario administrador edito la meta data del sitio web (Con titulo pero sin descripción)
  ...
  And I wait for 2 seconds
  And I enter title meta data "2"
  And I wait for 2 seconds
  And I enter description meta data "2"
  And I wait for 2 seconds
