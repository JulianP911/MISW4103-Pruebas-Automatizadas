...
@user1 @web
Scenario: Como usuario administrador creo un nuevo tag con Facebook card (Sin Facebook titulo pero con descripcion)
  ...
  And I wait for 2 seconds
  And I enter tag facebook title "3"
  And I wait for 2 seconds
  And I enter tag facebook description "3"
  And I wait for 2 seconds
  And I click save
  And I wait for 2 seconds
  And I click tags
